            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-primary d-flex align-items-center">
                        <h5 class="card-title"><strong>New Shift</strong></h5>
                        <div class="ml-auto">
                    ...
                    <form action="{{route('shift.store')}}" method="post">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="text" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" value="{{old('name')}}" name="name" placeholder="Shift name">
                                        @if($errors->has('name'))
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="start_time" data-target-input="nearest">
                                            <input type="time" name="start_time" class="form-control datetimepicker-input {{$errors->has('start_time') ? 'is-invalid' : ''}}" value="{{old('start_time')}}"  id="startTime" data-target="#start_time"/>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="break_from" data-target-input="nearest">
                                                ...
                                                <input type="time" name="break_from" class="form-control datetimepicker-input {{$errors->has('break_from') ? 'is-invalid' : ''}}" value="{{old('break_from')}}"   data-target="#break_from"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="break_to" data-target-input="nearest">
                                                ...
                                                <input type="time" name="break_to" class="form-control datetimepicker-input {{$errors->has('break_to') ? 'is-invalid' : ''}}" value="{{old('break_to')}}"  data-target="#break_to"/>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="close_time" data-target-input="nearest">
                                            <input type="time" name="close_time" class="form-control datetimepicker-input {{$errors->has('close_time') ? 'is-invalid' : ''}}" value="{{old('close_time')}}" data-target="#close_time"/>
                        ...
                        <div class="card-footer">
                            <div class="form-group text-center">
                                <button type="submit" class="btn btn-lg btn-outline-primary"> Create Shift </button>
                            </div>
                        </div>
                    </form>
                </div>
