...
@section('page-header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i class="fa fa-book-open"></i> CMS Pages </h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-gradient-info">
                        ...
                        <h5 class="card-title">Add - <strong>CMS Page</strong></h5>
                    </div>
                    ...
                    <form action="{{route('admin.addCmsPage')}}" method="post" id="addCms_page">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row my-0" >
                                ...
                                <div class="col-sm-4" style="margin-top: 0.3rem">
                                    <input type="text" name="sub_title" id="sub_title" class="form-control form-control-sm " >
